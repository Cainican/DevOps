$(document).ready(function () {
    ...
    function slideIn(selector) {
        ...
        $(selector).css({ opacity: 0, width: 0 }).animate({ opacity: 1, width: "100%" }, 1000);
    }
    ...
    function slideLeft(selector) {
        ...
        $(selector)
            .css({ position: "relative", opacity: 0, left: start })
