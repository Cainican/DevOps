$(function () {
    ...
    $("#easingBtn").on("click", function () {
        ...
        box1.animate({ width: "1200px" }, 1000, "linear");
        // TODO: box2 を width=300px でアニメーション: easing=swing
        box2.animate({ width: "1200px" }, 1500, "swing");
    })

    $("#animateBtn").on("click", function () {
        // TODO: box1 を width=300px height=50px opacity: 0.1 でアニメーション
        box1.animate({ width: "1200px", height: "50px", opacity: 0.1 }, 1000)
            .animate({ width: "1200px", height: "100px", opacity: 1 }, 1000);
        // TODO: box1 を width=100px height=100px opacity: 1 でアニメーション
        box1.animate({ width: "100px", height: "100px", opacity: 1 }, 1000)
        ...
        box2.animate({ width: "0px", opacity: 0.1 }, 500)
            .animate({ width: "1200px", opacity: 1 }, 500)
            .delay(1000)
            .animate({ width: "1200px", opacity: 1 }, 1000)
