...
// const sql = "SELECT name, email FROM users WHERE email = 'user1@test.com';"

// users テーブルから name に mr を含むユーザーを取得
// const sql = "SELECT name, email FROM users WHERE name LIKE '%mr%';"
...
const sql = `INSERT INTO feeds (user_id, content) VALUES ('${userId}', 'Hello');`

// TODO: SQLクエリー 実行: 非同期通信
